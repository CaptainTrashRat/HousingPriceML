...
with col2:
    zip_code  = st.text_input("Zip Code", value="07001")
...
if st.button("Predict Price", type="primary"):
    ...
    # Validate zip code
    if not zip_code.isdigit() or len(zip_code) < 3:
        st.error("Please enter a valid zip code (at least 3 digits).")
    else:
        # Build feature dict
        house_age  = 2024 - year_built
        zip_region = int(zip_code[:3])
        ...
        # Show a confidence range using MAPE
